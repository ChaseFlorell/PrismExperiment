...
/// </summary>
public static class PepNavigation
{
    ...
    /// <remarks>
    /// Will initialize a new Container Scope if the <see cref="ViewModelLocatorBehavior"/> is Forced.
    /// </remarks>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public static IContainerProvider GetContainerProvider(this BindableObject bindable)
    {
        ...
        else if(bindable is Page page)
        {
            ...
            if (PepViewModelLocator.GetAutowireViewModel(page) == ViewModelLocatorBehavior.Forced)
            {
