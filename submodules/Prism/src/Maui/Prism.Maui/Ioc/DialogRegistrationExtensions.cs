...
public static class DialogRegistrationExtensions
{
    ...
    /// </remarks>
    public static Pep.Ioc.IContainerRegistry RegisterDialog<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] TView>(this Pep.Ioc.IContainerRegistry containerRegistry, string name = null)
            where TView : View =>
    ...
    /// The view type must inherit from <see cref="View"/>.
    /// </remarks>
    public static Pep.Ioc.IContainerRegistry RegisterDialog<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] TView, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] TViewModel>(this Pep.Ioc.IContainerRegistry containerRegistry, string name = null)
        where TView : View =>
    ...
    /// The view type must inherit from <see cref="View"/>.
    /// </remarks>
    public static Pep.Ioc.IContainerRegistry RegisterDialog(this Pep.Ioc.IContainerRegistry container, Type view, Type viewModel, string name = null)
    {
    ...
    /// <param name="container">The container registry.</param>
    /// <returns>The container registry.</returns>
    public static Pep.Ioc.IContainerRegistry RegisterDialogContainer<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] T>(this Pep.Ioc.IContainerRegistry container)
